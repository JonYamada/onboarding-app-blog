p 'Seeding Users...'
User.find_or_create_by!(first_name: 'jon', last_name: 'yams', email: 'jonathon.yamada@wpengine.com', password_digest: BCrypt::Password.create(ENV['seeds_user_password']))
